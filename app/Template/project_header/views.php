<ul class="views">
    ...
    -->
    <li <?= $this->app->checkMenuSelection('PlanetTaskListController') ?>>
        <?= $this->url->icon('list', t('Lista Completa'), 'PlanetTaskListController', 'show', array('project_id' => $project['id'], 'search' => $filters['search']), false, 'view-listing', t('Keyboard shortcut: "%s"', 'v l')) ?>
    </li>
